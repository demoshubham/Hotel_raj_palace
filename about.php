	...
	<div class="container">
		<div class="row">
			<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center"
				style="background-image: url(img/blog-img/9.jpg); background-size: cover; height: 575px; padding-bottom: 0rem !important; ">

				<a href="img/raj.mp4" class="icon popup-vimeo d-flex justify-content-center align-items-center">
					<span class="icon-play"></span>
				</a>
			</div>
			<div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
				<div class="heading-section heading-section-wo-line  pl-md-5 mb-5" data-aos="zoom-in">
					<div class="ml-md-0">
						<span class="subheading">Welcome to RAJ PALACE Hotel</span>
						<h2 class="mb-4">Welcome To RAJ PALACE</h2>
					</div>
				</div>
				<div class="pb-md-5" data-aos="fade-up">
...
<section class="ftco-section" data-aos="zoom-in">
  <div class="container">
    <div class="row d-flex">
      ...
      <div class="col-md-3 d-flex align-sel Searchf-stretch ftco-animate">
        <div class="media block-6 services py-4 d-block text-center">
          ...
          <div class="media-body p-2 mt-2">
            <h3 class="heading mb-3">Banquet Services</h3>
            <p>A small river named Duden flows by their place and supplies.</p>
          </div>
        </div>
      </div>
